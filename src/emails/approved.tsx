      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Подготви се за 48 часа интензивно кодене, AI предизвикателства и невероятна атмосфера.
              Ще работиш в екип, ще използваш най-новите AI инструменти и ще създадеш нещо от нулата
              за рекордно време.
            </Text>
            <Text style={paragraph}>
              Очакваме те на място — храна, напитки, кафе и добра енергия са осигурени. Ти просто
              донеси лаптопа си и ентусиазъм!
            </Text>
          </Section>
