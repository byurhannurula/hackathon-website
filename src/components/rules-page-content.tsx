    ...
    <div className="bg-bg min-h-screen">
      ...
      <section className={sectionCls}>
        <div className={containerCls}>
          ...
          <ul className={listCls}>
            ...
            <li>
              Минимална възраст за участие: 16 години (непълнолетни участват с декларация от
              родител/настойник)
            </li>
            <li>
              Участието е безплатно и включва храна, напитки и достъп до всички менторски сесии
            </li>
          ...
          <ul className={listCls}>
            ...
            <li>
              Използването на публични библиотеки, API-та и open-source инструменти е разрешено
            </li>
      ...
      <section className={sectionCls}>
        <div className={containerCls}>
          ...
          <ul className={listCls}>
            ...
            <li>
              Организаторите имат право да използват името, описанието и демо на проекта за
              промоционални цели
            </li>
            <li>
              С участието си, вие давате съгласие за заснемане (снимки и видео) по време на
              събитието
            </li>
      ...
      <section className={sectionCls}>
        <div className={containerCls}>
          ...
          <ul className={listCls}>
            <li>
              Всеки отбор представя проекта си пред журито в рамките на 5 минути + 2 мин. въпроси
            </li>
            <li>
              Журито оценява по критериите: иновативност, техническо изпълнение, дизайн/UX,
              приложимост и презентация
            </li>
          ...
          <ul className={listCls}>
            ...
            <li>
              За получаване на парична награда е необходимо предоставяне на банкова сметка (IBAN)
            </li>
            <li>
              Организаторите си запазват правото да не присъдят награда, ако нито един проект не
              отговаря на минималните стандарти
            </li>
      ...
      <section className={sectionCls}>
        <div className={containerCls}>
          <h2 className={h2Cls}>ДИСКВАЛИФИКАЦИЯ</h2>
          ...
          <ul className={listCls}>
            ...
            <li>
              Всяко друго действие, което организаторите считат за несъвместимо с духа на събитието
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className={sectionCls}>
        <div className={containerCls}>
          ...
          <ul className={listCls}>
            <li>
              Личните данни се събират и обработват единствено за целите на организацията на
              събитието
            </li>
            <li>
              Данните се съхраняват сигурно и не се споделят с трети лица, освен за целите на
              събитието
            </li>
            <li>
              Участниците имат право да поискат изтриване на данните си след приключване на
              събитието
            </li>
