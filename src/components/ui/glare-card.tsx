...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate contain-[layout_style] perspective-[600px] transition-transform duration-(--duration) ease-(--easing) delay-(--delay) will-change-transform w-full aspect-17/21"
      ref={refElement}
      onPointerMove={(event) => {
