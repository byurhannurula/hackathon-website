...
const aiIcons: FloatingIconProps[] = [
  ...
  { id: 2, icon: IconCpu, className: 'top-[22%] right-[10%]' },
  { id: 3, icon: IconBot, className: 'bottom-[15%] left-[12%]' },
  ...
  { id: 7, icon: IconOrbit, className: 'bottom-[25%] left-[30%]' },
  { id: 8, icon: IconLayers, className: 'bottom-[20%] right-[38%]' },
  ...
  { id: 16, icon: IconSparkles, className: 'top-[75%] right-[45%]' },
  { id: 17, icon: IconZap, className: 'top-[60%] left-[15%]' },
  { id: 18, icon: IconNetwork, className: 'top-[65%] right-[5%]' },
];
