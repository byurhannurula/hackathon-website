    ...
    <div className="bg-bg min-h-screen">
      ...
      <section className="pt-[140px] pb-16 px-6 md:px-12">
        <div className={containerCls}>
          ...
          <p className="font-mono text-sm text-white/55 leading-[1.9] mt-6 max-w-[600px]">
            Практическа информация за участниците в RUSE AI HACK &apos;26 — какво да очакваш,
            как да се подготвиш и какво ще се случи на място.
          </p>
        </div>
      </section>
      ...
      <section className={sectionCls}>
        <div className={containerCls}>
          ...
          <p className={pCls}>
            Събитието е присъствено и се провежда в Русенски Университет. Участието е безплатно,
            но местата са ограничени — регистрацията минава през селекция.
          </p>
        </div>
      </section>
      ...
      <section className={sectionCls}>
        <div className={containerCls}>
          ...
          <p className={pCls}>
            Работи се на отбори от 2 до 5 човека. Можеш да дойдеш с готов отбор или да
            сформираш такъв на място в петък вечерта по време на opening mixer-а. Целта е за 48
            часа да създадеш работещ AI прототип.
          </p>
      ...
      <section className={sectionCls}>
        <div className={containerCls}>
          ...
          <p className={pCls}>
            Не е задължително да имаш опит с AI, но няколко неща ще ти помогнат да бъдеш по-ефективен:
          </p>
          <ul className={listCls}>
            <li>
              <strong>Настрой си средата:</strong> Имай готов IDE, Node.js/Python или каквото ползваш,
              и тествай, че всичко работи преди събитието
            </li>
            <li>
