...
export const AGENDA_DAYS: AgendaDay[] = [
  {
    ...
    date: "Петък",
    items: [
      { time: "17:30 – 18:30", label: "Регистрация и welcome networking", desc: "" },
      { time: "18:30 – 19:00", label: "Официално откриване", desc: "" },
      { time: "19:00 – 19:30", label: "Представяне на партньори, формат и правила", desc: "" },
      { time: "19:30 – 20:15", label: "Презентиране на идеи и сформиране на отбори", desc: "" },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "17:30 – 19:00", label: "Checkpoint и менторски сесии", desc: "" },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "09:00 – 12:00", label: "Финални корекции и подготовка на демо", desc: "" },
      { time: "12:00", label: "Краен срок за предаване на проектите", desc: "" },
