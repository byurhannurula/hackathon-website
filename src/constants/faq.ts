...
export const FAQ_ITEMS: FaqEntry[] = [
  ...
  },
  {
    ...
    answer: "Да, участието е безплатно.",
  },
  {
  ...
  },
  {
    ...
    answer: "Присъствено в Русе, България.",
  },
  {
    question: "Какво е vibe coding?",
    answer:
      "Vibe coding е начин за създаване на софтуер, при който описваш с обикновен език какво искаш, а AI генерира кода вместо теб или заедно с теб.",
  },
];
